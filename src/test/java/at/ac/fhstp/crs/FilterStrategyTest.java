...
public class FilterStrategyTest {
    ...
    @BeforeEach
    public void setUp() {
        apiConnector = mock(CoinMarketAPIConnector.class);
    }
    ...
    void testSortByValueList() {
        ...
        List<Token> filtered = filterStrategy.filterTokens(
                apiConnector.getTokens(3)
        );
    ...
    void testSortByChangeInPeriodList() {
        ...
        // sorting by price
        ITokenFilterStrategy filterStrategy = new SortByChangeInPeriod(
        ...
        // sorting by price
        filterStrategy =
                new SortByChangeInPeriod(ETokenChangePeriod.HOURS_24, true);
        filtered = filterStrategy.filterTokens(apiConnector.getTokens(3));
        assertThat(filtered.toArray(), arrayContaining(t1, t3, t2));
    }
}
